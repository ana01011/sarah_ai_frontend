...
//       {/* Header */}
//       <div className="bg-white pl-14 border-b px-4 py-3 flex items-center justify-between shadow-sm z-10" style={{ borderColor: currentTheme.colors.border }}>
...
//   return (
//     <div className="flex flex-col h-full bg-slate-50">
//       {/* Header - Clean, no menu button. Back button on left. Global Menu on Top-Right. */}
...
//           </div>
//         </div>
//         {/* Right side is empty, reserving space for the global floating menu button */}
