...
export const themes: Theme[] = [
  ...
  },
  {
    id: 'executive-gold',
    name: 'Executive Gold',
    description: 'Luxurious gold theme for C-level executives',
    colors: {
      primary: '#f59e0b',
      secondary: '#d97706',
      accent: '#92400e',
    ...
    gradients: {
      primary: 'from-amber-500 via-yellow-500 to-orange-500',
      secondary: 'from-yellow-500 via-amber-500 to-orange-500',
  ...
  },
  {
    ...
    description: 'Dynamic orange for operations leaders',
    colors: {
      primary: '#ea580c',
      secondary: '#dc2626',
      accent: '#c2410c',
    ...
    gradients: {
      ...
      background: 'from-stone-950 via-orange-950/30 to-stone-950',
    },
    shadows: {
      primary: 'rgba(234, 88, 12, 0.4)',
      secondary: 'rgba(220, 38, 38, 0.4)',
      accent: 'rgba(194, 65, 12, 0.4)',
    },
  },
  {
    id: 'product-teal',
