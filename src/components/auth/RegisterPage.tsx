...
import { Eye, EyeOff, Mail, Lock, User, ArrowRight, Brain, Sparkles, Check } from 'lucide-react';
...
export const RegisterPage: React.FC<RegisterPageProps> = ({ onSwitchToLogin }) => {
  ...
  const getStrengthColor = (strength: number) => {
    if (strength <= 2) return currentTheme.colors.error;
    if (strength <= 3) return currentTheme.colors.warning;
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onBlur={(e) => {
                    e.currentTarget.style.borderColor = formData.confirmPassword && formData.password !== formData.confirmPassword 
                      ? currentTheme.colors.error 
                      : currentTheme.colors.border;
                    e.currentTarget.style.backgroundColor = currentTheme.colors.surface + '60';
                  }}
              ...
              {formData.confirmPassword && formData.password !== formData.confirmPassword && (
                <p className="mt-1 text-xs" style={{ color: currentTheme.colors.error }}>
            ...
            <div className="flex items-start space-x-3">
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-5 h-5 rounded border-2 transition-colors opacity-0"
                  style={{
                    borderColor: currentTheme.colors.border,
                  }}
                />
                <div 
                  className="absolute inset-0 w-5 h-5 rounded border-2 transition-all duration-200 flex items-center justify-center cursor-pointer"
                  style={{
                    borderColor: formData.acceptTerms ? currentTheme.colors.primary : currentTheme.colors.border,
                    backgroundColor: formData.acceptTerms ? currentTheme.colors.primary : 'transparent'
                  }}
            ...
            <div className="relative">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t" style={{ borderColor: currentTheme.colors.border }} />
              </div>
            ...
            <button
              ...
              className="w-full py-4 px-6 rounded-xl font-semibold transition-all duration-300 
                       ...
                       flex items-center justify-center space-x-3 border
