...
import { Mail, ArrowRight, RefreshCw, ArrowLeft, Clock, CheckCircle } from 'lucide-react';
...
export const VerifyEmailPage: React.FC<{ 
  ...
  const { verifyOTP, resendOTP, error, isLoading, clearError, verificationEmail } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await verifyOTP(verificationEmail, otpString);
      setIsSuccess(true);
      setTimeout(() => {
      ...
      >
        <div className="text-center">
          <div className="relative inline-block mb-6">
            <div 
              className="absolute -inset-4 rounded-full blur-lg opacity-40 animate-pulse"
              style={{ backgroundColor: currentTheme.colors.success }}
            />
            <CheckCircle 
              className="w-20 h-20 mx-auto relative animate-bounce" 
              style={{ color: currentTheme.colors.success }}
            />
          </div>
          
          <h2 className="text-2xl font-bold mb-4" style={{ color: currentTheme.colors.success }}>
            Email Verified Successfully!
          </h2>
          
          <p className="text-sm mb-6" style={{ color: currentTheme.colors.textSecondary }}>
            Welcome to SARAH AI! Redirecting you to the dashboard...
          </p>
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm font-semibold mb-4" style={{ color: currentTheme.colors.primary }}>
            {verificationEmail}
          </p>
